...
const ColorSwatch = ({
  ...
  hex: string;
  role?: string;
  variants: { dark: string; light: string; highlight: string };
}) => (
  <div class={styles.colorSwatch}>
    <div class={styles.colorBox}>
      ...
      <div class={styles.variantContainer}>
        <div
          class={styles.variantBox}
          style={{ backgroundColor: `var(--color-${colorName}-dark)` }}
        ></div>
        <div
          class={styles.variantBox}
          style={{ backgroundColor: `var(--color-${colorName}-light)` }}
        ></div>
        <div
          class={styles.variantBox}
          style={{ backgroundColor: `var(--color-${colorName}-highlight)` }}
        ></div>
      </div>
    </div>
    <div class={styles.colorInfo}>
      ...
      <Text variant='caption' color='subtle' as='span' class={styles.hexValue}>
        {hex}
      </Text>
      <Text variant='caption' color='subtle' as='span' class={styles.hexValue}>
        ({variants.dark}, {variants.light}, {variants.highlight})
      </Text>
    </div>
  </div>
);
    ...
    <div class={styles.container}>
      ...
      <section class={styles.section}>
        ...
        <section class={styles.subSection}>
          <Heading level={3} variant='subSectionHeader'>
            General Colors
          </Heading>
          ...
          <div class={styles.grid}>
            <ColorSwatch
              name='Canvas White'
              colorName='canvas-white'
              hex='#fefaeF'
              variants={{ dark: '#d5d1c9', light: '#ffffff', highlight: '#ffffff' }}
            />
            <ColorSwatch
              name='Charcoal'
              colorName='charcoal'
              hex='#2d2d2d'
              variants={{ dark: '#1e1e1e', light: '#4c4c4c', highlight: '#6b6b6b' }}
            />
            <ColorSwatch
              name='Stone Grey'
              colorName='stone-grey'
              hex='#7a7a7a'
              variants={{ dark: '#5c5c5c', light: '#999999', highlight: '#b8b8b8' }}
            />
            <ColorSwatch
              name='Glow Yellow'
              colorName='glow-yellow'
              hex='#ffef9f'
              variants={{ dark: '#dccb86', light: '#fff5bc', highlight: '#fffbe0' }}
            />
          </div>
        </section>
        ...
        <section class={styles.subSection}>
          ...
          <div class={styles.grid}>
            <ColorSwatch
              ...
              hex='#f5b83d'
              role='Primary'
              variants={{ dark: '#d19a2f', light: '#f8c659', highlight: '#fbd47b' }}
            />
            <ColorSwatch
              name='Slate Blue'
              ...
              hex='#5B6B7A'
              role='Secondary'
              variants={{ dark: '#465460', light: '#7a8a99', highlight: '#9caab8' }}
            />
          </div>
        </section>
        ...
        <section class={styles.subSection}>
          ...
          <Text color='subtle'>
            Used for status indicators like success, error, or informational messages.
          </Text>
          <div class={styles.grid}>
            <ColorSwatch
              name='Moss Green'
              ...
              hex='#87a06f'
              variants={{ dark: '#6e8558', light: '#a0b88b', highlight: '#bad0a8' }}
            />
            <ColorSwatch
              name='Clay Red'
              colorName='clay-red'
              hex='#d47a6a'
              variants={{ dark: '#b56254', light: '#e1988b', highlight: '#edb6ac' }}
            />
            <ColorSwatch
              name='Deep Purple'
              colorName='deep-purple'
              hex='#7e718c'
              variants={{ dark: '#645a70', light: '#988fa6', highlight: '#b3a9be' }}
            />
            <ColorSwatch
              name='Pastel Sky'
              colorName='pastel-sky'
              hex='#a9d7e8'
              variants={{ dark: '#8cb6c6', light: '#c2e2ee', highlight: '#dcf0f8' }}
            />
          </div>
        </section>
      </section>
      ...
      <section class={styles.section}>
        ...
        <Text color='subtle'>
          Here are the reusable typography components. Use <code>{'<Heading>'}</code> for all titles
          and
      ...
      <section class={styles.section}>
        ...
        <section class={styles.subSection}>
          ...
          <Text color='subtle'>
            Actual color system: Amber (hex-amber), Default (slate-blue), Green (moss-green), Red
            (clay-red), Purple (deep-purple), Grey (stone-grey), White (canvas-white), Blue
            (pastel-sky), Yellow (glow-yellow).
          </Text>
          <div class={styles.buttonRow}>
            <Button onClick={() => {}} color={StyleColor.AMBER}>
              Amber
            </Button>
            <Button onClick={() => {}} color={StyleColor.DEFAULT}>
              Default
            </Button>
            <Button onClick={() => {}} color={StyleColor.GREEN}>
              Green
            </Button>
            <Button onClick={() => {}} color={StyleColor.RED}>
              Red
            </Button>
          </div>
          <div class={styles.buttonRow}>
            <Button onClick={() => {}} color={StyleColor.PURPLE}>
              Purple
            </Button>
            <Button onClick={() => {}} color={StyleColor.GREY}>
              Grey
            </Button>
            <Button onClick={() => {}} color={StyleColor.WHITE}>
              White
            </Button>
            <Button onClick={() => {}} color={StyleColor.BLUE}>
              Blue
            </Button>
          </div>
          <div class={styles.buttonRow}>
            <Button onClick={() => {}} color={StyleColor.YELLOW}>
              Yellow
            </Button>
            <Button onClick={() => {}} color={StyleColor.AMBER} disabled>
              Disabled
            </Button>
          </div>
          <div class={styles.buttonRow}>
        ...
        <section class={styles.subSection}>
          ...
          <Text color='subtle'>
            Buttons can now include icons with configurable positioning using the icon and
            iconPosition props. Icons automatically match the button text color for proper contrast:
            white for most buttons, grey for white/yellow buttons. Icons also receive the same text
            shadow as button text for visual consistency.
          </Text>
          <div class={styles.buttonRow}>
            <Button onClick={() => {}} color={StyleColor.AMBER} icon='save'>
              Save Game
            </Button>
            <Button
              onClick={() => {}}
            ...
            <Button onClick={() => {}} color={StyleColor.RED} icon='trash'>
              Delete
            </Button>
            <Button onClick={() => {}} color={StyleColor.BLUE} icon='settings'>
              Settings
            </Button>
          </div>
          <div class={styles.buttonRow}>
            <Button onClick={() => {}} color={StyleColor.DEFAULT} icon='arrow-left'>
              Back
            </Button>
            <Button
              onClick={() => {}}
            ...
            <Button onClick={() => {}} color={StyleColor.PURPLE} icon='star'>
              Favorite
            </Button>
            <Button onClick={() => {}} color={StyleColor.YELLOW} icon='heart'>
              Like
            </Button>
          </div>
          <div class={styles.buttonRow}>
          ...
          <div class={styles.buttonRow}>
            <Button onClick={() => {}} color={StyleColor.WHITE} icon='settings'>
              Settings (Grey Icon)
            </Button>
            <Button
              onClick={() => {}}
      ...
      <section class={styles.section}>
        ...
        <Text color='subtle'>
          Text input components with parchment-like styling that matches the game&apos;s medieval
          theme.
        </Text>
      ...
      <section class={styles.section}>
        ...
        <Text color='subtle'>
          Checkbox components with parchment-like styling that matches the game&apos;s medieval
          theme.
        </Text>
      ...
      <section class={styles.section}>
        ...
        <Text color='subtle'>
          Available icons for UI elements. Icons scale with text using em units for perfect
          integration.
        </Text>

        <section class={styles.subSection}>
          <Heading level={3} variant='subSectionHeader' color='subtle'>
            Icon Sizes with Text
          </Heading>
          <Text color='subtle'>Icons scale relative to their text context:</Text>
          <div class={styles.iconSizeExamples}>
            <Text>
              Extra Small <Icon name='heart' size={iconSizes.xs} color={StyleColor.RED} /> (0.5em)
            </Text>
            <Text>
              Small <Icon name='star' size={iconSizes.sm} color={StyleColor.AMBER} /> (0.75em)
            </Text>
            <Text>
              Medium <Icon name='settings' size={iconSizes.md} color={StyleColor.DEFAULT} /> (1em -
              default)
            </Text>
            <Text font='bold'>
              Large <Icon name='award' size={iconSizes.lg} color={StyleColor.GREEN} /> (2em)
            </Text>
            <Heading level={3} variant='subSectionHeader'>
              Extra Large <Icon name='hexagon' size={iconSizes.xl} color={StyleColor.AMBER} /> (3em)
            </Heading>
          </div>
        </section>
