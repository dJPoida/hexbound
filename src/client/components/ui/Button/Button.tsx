    ...
    >
      {
        ...
        >
          ...
          <path d='M 4,42 V 8 L 0,6 v 38 z' className={styles.leftEdge} />

          {/* Right edge - dynamic position (from actual artwork) */}
          <path d={`m ${svgWidth - 4},8 4,-2 v 38 l -4,-2 z`} className={styles.rightEdge} />

          {/* Top edge - stretches with button width (from actual artwork) */}
          <path d={`M 8,4 6,0 h ${svgWidth - 12} l -2,4 z`} className={styles.topEdge} />
